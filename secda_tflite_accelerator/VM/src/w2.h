...
#pragma HLS RESOURCE variable=od17ct core=Mul
	...
	while(1){
		...
		ACC_DTYPE<32> i1 = lhsdata1b[l_pointer];
		ACC_DTYPE<32> i2 = lhsdata2b[l_pointer];
		ACC_DTYPE<32> i3 = lhsdata3b[l_pointer];
		ACC_DTYPE<32> i4 = lhsdata4b[l_pointer];

		ACC_DTYPE<32> w1 = rhs2a_1[0];
		ACC_DTYPE<32> w2 = rhs2b_1[0];
		ACC_DTYPE<32> w3 = rhs2c_1[0];
		ACC_DTYPE<32> w4 = rhs2d_1[0];
		...
		for (int rin = 1; rin < d ; rin++){
			  ...
			  i1 = lhsdata1b[rin+l_pointer];
			  i2 = lhsdata2b[rin+l_pointer];
			  i3 = lhsdata3b[rin+l_pointer];
			  i4 = lhsdata4b[rin+l_pointer];
