...
wait();
	while(true){
		...
		d.data.range(7,0) = r1.d3.range(7,0);
		d.data.range(15,8) = r1.d7.range(7,0);
		d.data.range(23,16) = r1.d11.range(7,0);
		d.data.range(31,24) = r1.d15.range(7,0);
		dout2.write(d);
		DWAIT();
		write1_2.write(0);

		while(!arrange2.read())wait();
		d.data.range(7,0) = r2.d3.range(7,0);
		d.data.range(15,8) = r2.d7.range(7,0);
		d.data.range(23,16) = r2.d11.range(7,0);
		d.data.range(31,24) = r2.d15.range(7,0);
		dout2.write(d);
		DWAIT();
		write2_2.write(0);

		while(!arrange3.read())wait();
		d.data.range(7,0) = r3.d3.range(7,0);
		d.data.range(15,8) = r3.d7.range(7,0);
		d.data.range(23,16) = r3.d11.range(7,0);
		d.data.range(31,24) = r3.d15.range(7,0);
		dout2.write(d);
		DWAIT();
		write3_2.write(0);

		while(!arrange4.read())wait();
		d.data.range(7,0) = r4.d3.range(7,0);
		d.data.range(15,8) = r4.d7.range(7,0);
		d.data.range(23,16) = r4.d11.range(7,0);
		d.data.range(31,24) = r4.d15.range(7,0);
		dout2.write(d);
		DWAIT();
		write4_2.write(0);
	}
