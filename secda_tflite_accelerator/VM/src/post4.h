...
wait();
	while(true){
		...
		d.data.range(7,0) = r1.d5.range(7,0);
		d.data.range(15,8) = r1.d9.range(7,0);
		d.data.range(23,16) = r1.d13.range(7,0);
		d.data.range(31,24) = r1.d17.range(7,0);
		dout4.write(d);
		DWAIT();
		write1_4.write(0);

		while(!arrange2.read())wait();
		d.data.range(7,0) = r2.d5.range(7,0);
		d.data.range(15,8) = r2.d9.range(7,0);
		d.data.range(23,16) = r2.d13.range(7,0);
		d.data.range(31,24) = r2.d17.range(7,0);
		dout4.write(d);
		DWAIT();
		write2_4.write(0);

		while(!arrange3.read())wait();
		d.data.range(7,0) = r3.d5.range(7,0);
		d.data.range(15,8) = r3.d9.range(7,0);
		d.data.range(23,16) = r3.d13.range(7,0);
		d.data.range(31,24) = r3.d17.range(7,0);
		dout4.write(d);
		DWAIT();
		write3_4.write(0);

		while(!arrange4.read())wait();
		d.data.range(7,0) = r4.d5.range(7,0);
		d.data.range(15,8) = r4.d9.range(7,0);
		d.data.range(23,16) = r4.d13.range(7,0);
		d.data.range(31,24) = r4.d17.range(7,0);
		dout4.write(d);
		DWAIT();
		write4_4.write(0);
	}
