...
wait();
	while(true){
		while(!arrange1.read())wait();
		d.data.range(7,0) = r1.d2.range(7,0);
		d.data.range(15,8) = r1.d6.range(7,0);
		d.data.range(23,16) = r1.d10.range(7,0);
		d.data.range(31,24) = r1.d14.range(7,0);
		dout1.write(d);
		DWAIT();
		write1_1.write(0);

		while(!arrange2.read())wait();
		d.data.range(7,0) = r2.d2.range(7,0);
		d.data.range(15,8) = r2.d6.range(7,0);
		d.data.range(23,16) = r2.d10.range(7,0);
		d.data.range(31,24) = r2.d14.range(7,0);
		dout1.write(d);
		DWAIT();
		write2_1.write(0);

		while(!arrange3.read())wait();
		d.data.range(7,0) = r3.d2.range(7,0);
		d.data.range(15,8) = r3.d6.range(7,0);
		d.data.range(23,16) = r3.d10.range(7,0);
		d.data.range(31,24) = r3.d14.range(7,0);
		dout1.write(d);
		DWAIT();
		write3_1.write(0);

		while(!arrange4.read())wait();
		d.data.range(7,0) = r4.d2.range(7,0);
		d.data.range(15,8) = r4.d6.range(7,0);
		d.data.range(23,16) = r4.d10.range(7,0);
		d.data.range(31,24) = r4.d14.range(7,0);
		dout1.write(d);
		DWAIT();
		write4_1.write(0);
	}
