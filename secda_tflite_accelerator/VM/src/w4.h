...
#pragma HLS RESOURCE variable=od17ct core=Mul
	...
	while(1){
		...
		ACC_DTYPE<32> i1 = lhsdata1d[l_pointer];
		ACC_DTYPE<32> i2 = lhsdata2d[l_pointer];
		ACC_DTYPE<32> i3 = lhsdata3d[l_pointer];
		ACC_DTYPE<32> i4 = lhsdata4d[l_pointer];

		ACC_DTYPE<32> w1 = rhs4a_1[0];
		ACC_DTYPE<32> w2 = rhs4b_1[0];
		ACC_DTYPE<32> w3 = rhs4c_1[0];
		ACC_DTYPE<32> w4 = rhs4d_1[0];
		...
		for (int rin = 1; rin < d ; rin++){
			...
			i1 = lhsdata1d[rin+l_pointer];
			i2 = lhsdata2d[rin+l_pointer];
			i3 = lhsdata3d[rin+l_pointer];
			i4 = lhsdata4d[rin+l_pointer];
