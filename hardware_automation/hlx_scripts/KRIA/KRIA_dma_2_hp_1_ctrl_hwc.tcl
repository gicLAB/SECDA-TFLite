...
#
# DMA_EXP_2_0_hlx.tcl: Tcl script for re-creating project 'DMA_EXP_2_0_hlx'
#
# Generated by Vivado on Wed Feb 04 21:39:20 GMT 2026
...
#
# 1. This project restoration tcl script (DMA_EXP_2_0_hlx.tcl) that was generated.
#
...
set _xil_proj_name_ "DMA_EXP_2_0_hlx"
...
set script_file "DMA_EXP_2_0_hlx.tcl"
...
preplace inst ps8_0_axi_periph -pg 1 -lvl 4 -x 1760 -y 550 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 4 -x 1760 -y 970 -defaultsOSRD
preplace inst &{top} -pg 1 -lvl 1 -x 180 -y 920 -defaultsOSRD
preplace netloc rst_ps8_0_199M_peripheral_aresetn 1 0 4 -10 1030 460 1010 NJ 1010 1610
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 4 -30 810 450 760 850 760 1600
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 2 2 880J 790 1510
preplace netloc &{top}_M_AXIS_DATA1 1 1 1 370 860n
preplace netloc axi_dma_0_M_AXIS_MM2S 1 0 3 -10 770 NJ 770 820
preplace netloc axi_dma_0_M_AXI_MM2S 1 2 2 870J 820 1530
preplace netloc axi_dma_0_M_AXI_S2MM 1 2 2 860J 810 1540
preplace netloc axi_smc_M00_AXI 1 2 3 890 800 NJ 800 1910
preplace netloc ps8_0_axi_periph_M00_AXI 1 1 4 460 370 NJ 370 NJ 370 1910
preplace netloc ps8_0_axi_periph_M01_AXI 1 0 5 -40 350 NJ 350 NJ 350 NJ 350 1920
preplace netloc ps8_0_axi_periph_M02_AXI 1 0 5 -20 360 NJ 360 NJ 360 NJ 360 1930
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 3 1 1520 430n
levelinfo -pg 1 -60 180 640 1200 1760 1950
pagesize -pg 1 -db -bbox -sgen -60 0 3180 1260
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../mnt/Crucial/WorkspaceB/SECDA/SECDA-Sandbox/hardware_automation/generated/DMA_EXP_2_0/DMA_EXP_2_0_hlx/DMA_EXP_2_0_hlx.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
