...
#
# bfp_template.tcl: Tcl script for re-creating project 'bfp_template'
#
# Generated by Vivado on Wed Nov 05 21:11:02 GMT 2025
...
#
# 1. This project restoration tcl script (bfp_template.tcl) that was generated.
#
...
set _xil_proj_name_ "bfp_template"
...
set script_file "bfp_template.tcl"
...
\
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins ps8_0_axi_periph/M01_AXI] [get_bd_intf_pins &{top}_0/S_AXI_CTRL]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins ps8_0_axi_periph/M02_AXI] [get_bd_intf_pins &{top}_0/S_AXI_HWC]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs &{top}_0/S_AXI_CTRL/Reg] -force
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -with_name SEG_&{top}_0_Reg_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs &{top}_0/S_AXI_HWC/Reg] -force
...
preplace inst &{top}_0 -pg 1 -lvl 1 -x 180 -y 920 -defaultsOSRD
preplace netloc rst_ps8_0_199M_peripheral_aresetn 1 1 3 460 1010 NJ 1010 1600
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 1 3 460 770 850 770 1610
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 2 2 880J 800 1510
preplace netloc axi_dma_0_M_AXI_MM2S 1 2 2 870J 820 1530
preplace netloc axi_dma_0_M_AXI_S2MM 1 2 2 860J 810 1540
preplace netloc axi_smc_M00_AXI 1 2 3 890 1060 NJ 1060 1910
preplace netloc ps8_0_axi_periph_M00_AXI 1 1 4 450 1050 NJ 1050 1510J 1070 1920
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 3 1 1520 600n
levelinfo -pg 1 -10 180 640 1200 1760 1970
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../Workspace/bfp_template/bfp_template.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
