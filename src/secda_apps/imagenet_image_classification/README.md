...
Rpp modified command:
```
python /home/rppv15/workspace/SECDA-TFLite/src/secda_apps/imagenet_image_classification/generate_validation_labels.py \
--ilsvrc_devkit_dir=/home/rppv15/workspace/SECDA-TFLite/src/secda_apps/imagenet_image_classification/ILSVRC2012_devkit/ILSVRC2012_devkit_t12 \
--validation_labels_output=/home/rppv15/workspace/SECDA-TFLite/src/secda_apps/imagenet_image_classification/ILSVRC2012_devkit/ILSVRC2012_devkit_t12/validation_ground_truth_new.txt
```
...
bazel run -c opt \
  -- \
  //tensorflow/lite/tools/evaluation/tasks/imagenet_image_classification:run_eval \
  --model_file=/home/rppv15/workspace/SECDA-TFLite/tensorflow/models/test_models/mobilenetv1.tflite \
  --ground_truth_images_path=/home/rppv15/workspace/SECDA-TFLite/src/secda_apps/imagenet_image_classification/ILSVRC2012_devkit/ILSVRC2012_devkit_t12/ILSVRC2012_img_val \
  --ground_truth_labels=/home/rppv15/workspace/SECDA-TFLite/src/secda_apps/imagenet_image_classification/ILSVRC2012_devkit/ILSVRC2012_devkit_t12/validation_ground_truth.txt \
  --model_output_labels=/home/rppv15/workspace/SECDA-TFLite/src/secda_apps/imagenet_image_classification/ILSVRC2012_devkit/ILSVRC2012_devkit_t12/model_output_labels.txt \
  --output_file_path=/home/rppv15/workspace/SECDA-TFLite/src/secda_apps/imagenet_image_classification/ILSVRC2012_devkit/ILSVRC2012_devkit_t12/accuracy_output.txt \
  --num_images=10 # Run on all images.
```

(2) The output metrics are dumped into `/tmp/accuracy_output.txt` as a