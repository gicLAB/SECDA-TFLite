...
sc_int<16> VMM_UNIT::mul_s8(sc_int<8> a, sc_int<8> b) {
  sc_int<16> c;
...
#pragma HLS unroll
    ...
    for (int i = 0; i < 4; i++) {
#pragma HLS unroll
      prod[i * 4 + 0][0] = we_a[0 * 4 + i] * in_a[0 * 4 + 0];
      // prod[i * 4 + 1][0] = we_a[0 * 4 + i] * in_a[0 * 4 + 1];
      // prod[i * 4 + 2][0] = we_a[0 * 4 + i] * in_a[0 * 4 + 2];
      // prod[i * 4 + 3][0] = we_a[0 * 4 + i] * in_a[0 * 4 + 3];
      // prod[i * 4 + 0][1] = we_a[1 * 4 + i] * in_a[1 * 4 + 0];
      // prod[i * 4 + 1][1] = we_a[1 * 4 + i] * in_a[1 * 4 + 1];
