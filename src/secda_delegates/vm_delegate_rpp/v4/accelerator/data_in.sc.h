  ...
  while (1) {
    ...
    if (load_wgt) {
      ...
      for (int i = 0; i < wp.wgt_size; i++) {
        ...
        ACC_DTYPE<32> data1 = din1.read().data.to_int();
        ACC_DTYPE<32> data2 = din1.read().data.to_int();
        ACC_DTYPE<32> data3 = din1.read().data.to_int();
        ACC_DTYPE<32> data4 = din1.read().data.to_int();
        sc_bigint<32 * 4> data;
      ...
      for (int i = 0; i < wp.wgt_sum_size; i++) {
        ...
        ACC_DTYPE<32> wsums1 = din1.read().data.to_int();
        ACC_DTYPE<32> wsums2 = din1.read().data.to_int();
        ACC_DTYPE<32> wsums3 = din1.read().data.to_int();
        ACC_DTYPE<32> wsums4 = din1.read().data.to_int();
        ...
        ACC_DTYPE<32> rfs1 = din1.read().data.to_int();
        ACC_DTYPE<32> rfs2 = din1.read().data.to_int();
        ACC_DTYPE<32> rfs3 = din1.read().data.to_int();
        ACC_DTYPE<32> rfs4 = din1.read().data.to_int();
