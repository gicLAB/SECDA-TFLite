...
#define ACCNAME VM_RPP_INT8_V4_0
...
// #define VMM_COUNT 2
// #define VMM_COUNT 3
#define VMM_COUNT 2 //tested for 1, 2 and 4
#define ACC_DTYPE sc_int
#define ACC_C_DTYPE int

// Rpp configuration Start

#define REG_MULT_CORE
// #define BITSHIFT_OP // need to rename it BITSHIFT_CORE

// #define HEIDL_MULT_CORE
// #define MULT_HEIDL_LOOKUP_TABLE
