...
static unsigned int dma_addrs[1] = {dma_addr0}; //, dma_addr1, dma_addr2, dma_addr3
static unsigned int dma_addrs_in[1] = {dma_in0}; //, dma_in1, dma_in2, dma_in3
static unsigned int dma_addrs_out[1] = {dma_out0}; //, dma_out1, dma_out2, dma_out3
...
#else
static struct multi_dma mdma(1, dma_addrs, dma_addrs_in, dma_addrs_out, DMA_BL);
int *acc;
struct dma_buffer_set dfs[1] = {
...
public:
  ...
  TfLiteStatus Eval(TfLiteContext *context, TfLiteNode *node) override {
    ...
    for (int i = 0; i < node_count; i++) {
      ...
      // cout << "delegate nodes: " << dparams.delegated_nodes << endl;
      // exit(0);
    }
