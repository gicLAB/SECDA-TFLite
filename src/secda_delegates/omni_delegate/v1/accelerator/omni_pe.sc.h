...
SC_MODULE(SUBMODULENAME) {
  ...
  int Quantised_Multiplier(int x, int qm, int shift) {
    ...
    sc_int<32> omni_1;
    omni_1 = (val_2 + POS) / DIVMAX;
    if (val_2 < 0) omni_1 = (val_2 + NEG) / DIVMAX;
    sc_int<32> val_3 = omni_1;
    val_3 = val_3 >> pr;
    sc_int<32> omni_2 = omni_1 & msk;
    sc_int<32> omni_3 = (omni_1 < 0) & 1;
    sc_int<32> omni_4 = sm + omni_3;
    sc_int<32> omni_5 = ((omni_2 > omni_4) & 1);
    sc_int<32> result_32 = val_3 + omni_5;
    return result_32;
  }
...
#else
  omni_pe_var_array() : vars_0(16), HW0("HW0"), vars_1(16), HW1("HW1") {}
#endif

  omni_pe_vars &operator[](int i) {
