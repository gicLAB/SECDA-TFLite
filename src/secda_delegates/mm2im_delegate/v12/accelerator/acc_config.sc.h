...
#define DMA_INS_OFFSET 0x0000000
...
struct PE_vars {
  ...
  PE_vars(int size)
      : online("online"), compute("compute"), reset_compute("reset_compute"),
        ...
        ra_data("ra_data"), send("send"), cols_per_filter("cols_per_filter"),
        depth("depth"), compute_done("compute_done"), wgt_loaded("wgt_loaded"),
