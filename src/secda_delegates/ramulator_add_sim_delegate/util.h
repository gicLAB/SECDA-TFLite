#ifndef TENSORFLOW_LITE_DELEGATES_UTILS_RAMULATOR_ADD_DELEGATE_RAMULATOR_ADD_DELEGATE_UTIL_H_
#define TENSORFLOW_LITE_DELEGATES_UTILS_RAMULATOR_ADD_DELEGATE_RAMULATOR_ADD_DELEGATE_UTIL_H_
...
inline int32_t RoundingDivideByPOT(int32_t x, int exponent) {
  ...
  std::int32_t ramulator_add_2 = x & msk;
  std::int32_t ramulator_add_3 = (x < 0) & 1;
  std::int32_t ramulator_add_4 = sm + ramulator_add_3;
  std::int32_t ramulator_add_5 = ((ramulator_add_2 > ramulator_add_4) & 1);
  std::int32_t result_32 = val_3 + ramulator_add_5;
}
