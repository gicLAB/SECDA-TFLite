int ACCNAME::Quantised_Multiplier(int x, int qm, int shift) {
  ...
  sc_int<32> ramulator_add_1;
  ramulator_add_1 = (val_2 + POS) / DIVMAX;
  if (val_2 < 0) ramulator_add_1 = (val_2 + NEG) / DIVMAX;
  sc_int<32> val_3 = ramulator_add_1;
  val_3 = val_3 >> pr;
  sc_int<32> ramulator_add_2 = ramulator_add_1 & msk;
  sc_int<32> ramulator_add_3 = (ramulator_add_1 < 0) & 1;
  sc_int<32> ramulator_add_4 = sm + ramulator_add_3;
  sc_int<32> ramulator_add_5 = ((ramulator_add_2 > ramulator_add_4) & 1);
  sc_int<32> result_32 = val_3 + ramulator_add_5;
  return result_32;
}
