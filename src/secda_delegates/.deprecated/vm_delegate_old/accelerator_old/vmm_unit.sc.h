...
SC_MODULE(VMM_UNIT) {
  ...
  sc_fifo_out<p8x4> dout1;
  sc_fifo_out<p8x4> dout2;
  sc_fifo_out<p8x4> dout3;
  sc_fifo_out<p8x4> dout4;
  ...
  ACC_DTYPE<32> wgt_data1a[WGT_BUF_LEN];
  ACC_DTYPE<32> wgt_data2a[WGT_BUF_LEN];
  ACC_DTYPE<32> wgt_data3a[WGT_BUF_LEN];
  ACC_DTYPE<32> wgt_data4a[WGT_BUF_LEN];
...
struct var_array1 {
  ...
  int dout_read(int index, int dout_index) {
    if (index == 0 && dout_index == 0) return vars_0.dout1.read().data;
    else if (index == 0 && dout_index == 1) return vars_0.dout2.read().data;
    else if (index == 0 && dout_index == 2) return vars_0.dout3.read().data;
    else if (index == 0 && dout_index == 3) return vars_0.dout4.read().data;
    else return 0;
  }
...
struct var_array2 {
  ...
  int dout_read(int index, int dout_index) {
    ...
    else if (index == 1 && dout_index == 0) return vars_1.dout1.read().data;
    else if (index == 1 && dout_index == 1) return vars_1.dout2.read().data;
    else if (index == 1 && dout_index == 2) return vars_1.dout3.read().data;
    else if (index == 1 && dout_index == 3) return vars_1.dout4.read().data;
    else return 0;
  }
...
struct var_array3 {
...
#ifndef __SYNTHESIS__
  var_array3()
      : vars_0(16, 0), vars_1(16, 1), vars_2(16, 2), V0("V0"), V1("V1"),
        V2("V2") {}
#else
  var_array3()
      : vars_0(16), vars_1(16), vars_2(16), V0("V0"), V1("V1"), V2("V2") {}
#endif
  ...
  int dout_read(int index, int dout_index) {
    ...
    else if (index == 2 && dout_index == 0) return vars_2.dout1.read().data;
    else if (index == 2 && dout_index == 1) return vars_2.dout2.read().data;
    else if (index == 2 && dout_index == 2) return vars_2.dout3.read().data;
    else if (index == 2 && dout_index == 3) return vars_2.dout4.read().data;
    else return 0;
  }
...
struct var_array4 {
  ...
  int dout_read(int index, int dout_index) {
    ...
    else if (index == 3 && dout_index == 0) return vars_3.dout1.read().data;
    else if (index == 3 && dout_index == 1) return vars_3.dout2.read().data;
    else if (index == 3 && dout_index == 2) return vars_3.dout3.read().data;
    else if (index == 3 && dout_index == 3) return vars_3.dout4.read().data;
    else return 0;
  }
