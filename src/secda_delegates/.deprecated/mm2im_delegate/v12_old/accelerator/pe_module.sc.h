...
#pragma HLS RESOURCE variable = c core = Mul_LUT
  ...
  void init(sc_in<bool> & clock, sc_in<bool> & reset, PE_vars & vars) {
    ...
    this->crx_scale_data(vars.crx_scale_data);
...
struct var_array {
  ...
  void crx_scale_data_write(double data, int index) {
    if (index == 0) return vars_0.crx_scale_data.write(data);
    else if (index == 1) return vars_1.crx_scale_data.write(data);
    else if (index == 2) return vars_2.crx_scale_data.write(data);
    else if (index == 3) return vars_3.crx_scale_data.write(data);
    else if (index == 4) return vars_4.crx_scale_data.write(data);
    else if (index == 5) return vars_5.crx_scale_data.write(data);
    else if (index == 6) return vars_6.crx_scale_data.write(data);
    else if (index == 7) return vars_7.crx_scale_data.write(data);
  }
