...
static struct s_mdma mdma(4, dma_addrs, dma_addrs_in, dma_addrs_out, SYSC_DMA_BL);
ACCNAME *acc;
#else
struct s_mdma mdma(4, dma_addrs, dma_addrs_in, dma_addrs_out, DMA_BL);
int *acc;
#endif
...
#endif
      DTOG(std::cout << "MM2IM Accelerator v9");
#ifdef ACC_NEON
