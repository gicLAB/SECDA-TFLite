      ...
      for (int pe_dex = 0; pe_dex < nfilters; pe_dex++) {
        ...
        for (int i = 0; i < cpf; i++) {
          ...
          for (int j = 0; j < wp.wgt_depth; j++) {
            // this send 16 values at a time
            bUF d1;
            acc_dt array[UF];
            sc_uint<32> data1 = din1.read().data;
            sc_uint<32> data2 = din2.read().data;
            sc_uint<32> data3 = din3.read().data;
            sc_uint<32> data4 = din4.read().data;
            array[0] = data1.range(7, 0).to_int();
            array[1] = data1.range(15, 8).to_int();
            array[2] = data1.range(23, 16).to_int();
            array[3] = data1.range(31, 24).to_int();
            array[4] = data2.range(7, 0).to_int();
            array[5] = data2.range(15, 8).to_int();
            array[6] = data2.range(23, 16).to_int();
            array[7] = data2.range(31, 24).to_int();
            array[8] = data3.range(7, 0).to_int();
            array[9] = data3.range(15, 8).to_int();
            array[10] = data3.range(23, 16).to_int();
            array[11] = data3.range(31, 24).to_int();
            array[12] = data4.range(7, 0).to_int();
            array[13] = data4.range(15, 8).to_int();
            array[14] = data4.range(23, 16).to_int();
            array[15] = data4.range(31, 24).to_int();
            d1.insert(array);
