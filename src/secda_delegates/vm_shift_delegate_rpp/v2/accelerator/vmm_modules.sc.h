...
#pragma HLS pipeline II = 1
      ...
      wgt_data1a[(i*2)]   = data.data.range(15, 0);
      wgt_data1a[(i*2)+1] = data.data.range(31, 16);
      wgt_data2a[(i*2)]   = data.data.range(47, 32);
      wgt_data2a[(i*2)+1] = data.data.range(63, 48);
      wgt_data3a[(i*2)]   = data.data.range(79, 64);
      wgt_data3a[(i*2)+1] = data.data.range(95, 80);
      wgt_data4a[(i*2)]   = data.data.range(111, 96);
      wgt_data4a[(i*2)+1] = data.data.range(127, 112);
      DWAIT(1);
    }
  }
}
