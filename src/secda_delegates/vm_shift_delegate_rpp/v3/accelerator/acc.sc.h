...
// Rpp configuration Start

#ifdef MULT_HEIDL_LOOKUP_TABLE
const int scdm841_lookupTable[256][256]={0};
const int scdm842_lookupTable[256][256]={0};
#endif // MULT_HEIDL_LOOKUP_TABLE

// Rpp configuration End
