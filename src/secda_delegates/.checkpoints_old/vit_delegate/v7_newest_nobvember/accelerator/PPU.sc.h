...
#pragma HLS UNROLL
          ...
          value1 = Quantised_Multiplier(local_res[0], local_crf[0], local_crx[0]);
          value2 = Quantised_Multiplier(local_res[1], local_crf[1], local_crx[1]);
          value3 = Quantised_Multiplier(local_res[2], local_crf[2], local_crx[2]);
          value4 = Quantised_Multiplier(local_res[3], local_crf[3], local_crx[3]);
#else
...
#else
          value1 = Quantised_Multiplier(res[i][j + 0], crf, pl, pr, msk, sm );
          wait();
          value2 = Quantised_Multiplier(res[i][j + 1], crf, pl, pr, msk, sm );
          wait();
          value3 = Quantised_Multiplier(res[i][j + 2], crf, pl, pr, msk, sm );
          wait();
          value4 = Quantised_Multiplier(res[i][j + 3], crf, pl, pr, msk, sm );
          wait();
