...
#pragma HLS UNROLL
        ...
        wait(); // a
        wait(); // Additional synchronization before using values
        wait(); // Extra pipeline stage for value stabilization

        svalue1 = values[0] + cur_ra;
        svalue2 = values[1] + cur_ra;
        svalue3 = values[2] + cur_ra;
        svalue4 = values[3] + cur_ra;
