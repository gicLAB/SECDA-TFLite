...
// #pragma HLS UNROLL
            ...
            // // print out crx pl, pr, msk, sm
            // cout << "[VIT v7 ACC] PPU: local_crx[" << c << "]=" << local_crx[c]
            //      << ", pl=" << local_pl[c] << ", pr=" << local_pr[c]
            //      << ", msk=" << local_msk[c] << ", sm=" << local_sm[c]
            //      << std::endl;
          }
