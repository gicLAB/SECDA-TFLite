...
SC_MODULE(ACCNAME) {
  ...
  // new sums bram
  ACC_DTYPE<32> lhs_sum1[WSUMS_BUF_LEN];
  ACC_DTYPE<32> lhs_sum2[WSUMS_BUF_LEN];
  ACC_DTYPE<32> lhs_sum3[WSUMS_BUF_LEN];
  ACC_DTYPE<32> lhs_sum4[WSUMS_BUF_LEN];

  ACC_DTYPE<32> rhs_sum1[ISUMS_BUF_LEN];
  ACC_DTYPE<32> rhs_sum2[ISUMS_BUF_LEN];
  ACC_DTYPE<32> rhs_sum3[ISUMS_BUF_LEN];
  ACC_DTYPE<32> rhs_sum4[ISUMS_BUF_LEN];
...
#ifndef __SYNTHESIS__
  // Profiling variable
  ClockCycles *cycles_layer = new ClockCycles("cycles_layer", true);
  ...
  std::vector<Metric *> profiling_vars = {
      cycles_layer, read_cycles,  process_cycles, idle1,       idle2,   idle4,
      idle1,        gemmw1,       gemmw2,         gemmw3,      gemmw4,  gemm1,
      gemm2,        gemm3,        gemm4,          wstall1,     wstall2, wstall3,
      wstall4,      gweightbuf_p, inputbuf_p,     weightbuf_p, gmacs,   gouts,
  };
#endif
