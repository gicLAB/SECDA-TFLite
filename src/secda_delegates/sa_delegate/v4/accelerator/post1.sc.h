...
#pragma HLS pipeline II = 1
        ...
        sc_int<32> f1_a3 = ret_accum3 + ra;
        sc_int<32> f1_a4 = ret_accum4 + ra;
        ...
        if (f1_a2 > MAX8) f1_a2 = MAX8;
        else if (f1_a2 < MIN8) f1_a2 = MIN8;
        if (f1_a3 > MAX8) f1_a3 = MAX8;
        else if (f1_a3 < MIN8) f1_a3 = MIN8;
        if (f1_a4 > MAX8) f1_a4 = MAX8;
        else if (f1_a4 < MIN8) f1_a4 = MIN8;
        pram[(i * 16) + j + 0] = f1_a1.range(7, 0);
