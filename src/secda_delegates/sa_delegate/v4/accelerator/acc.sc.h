...
SC_MODULE(ACCNAME) {
  ...
  // GEMM 1 Inputs
  ACC_DTYPE<32> wgt_data1a[IN_BUF_LEN];
  ACC_DTYPE<32> wgt_data2a[IN_BUF_LEN];
  ACC_DTYPE<32> wgt_data3a[IN_BUF_LEN];
  ACC_DTYPE<32> wgt_data4a[IN_BUF_LEN];

  // Global Weights
  ACC_DTYPE<32> inp_data1[WE_BUF_LEN];
  ACC_DTYPE<32> inp_data2[WE_BUF_LEN];
  ACC_DTYPE<32> inp_data3[WE_BUF_LEN];
  ACC_DTYPE<32> inp_data4[WE_BUF_LEN];

  // new sums bram
  ACC_DTYPE<32> wgt_sum1[SUMS_BUF_LEN];
  ACC_DTYPE<32> wgt_sum2[SUMS_BUF_LEN];
  ACC_DTYPE<32> wgt_sum3[SUMS_BUF_LEN];
  ACC_DTYPE<32> wgt_sum4[SUMS_BUF_LEN];

  ACC_DTYPE<32> inp_sum1[SUMS_BUF_LEN];
  ACC_DTYPE<32> inp_sum2[SUMS_BUF_LEN];
  ACC_DTYPE<32> inp_sum3[SUMS_BUF_LEN];
  ACC_DTYPE<32> inp_sum4[SUMS_BUF_LEN];
