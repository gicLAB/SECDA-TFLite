#ifndef TENSORFLOW_LITE_DELEGATES_UTILS_PREP_FCGEMM_DELEGATE_FCGEMM_DELEGATE_UTIL_H_
#define TENSORFLOW_LITE_DELEGATES_UTILS_PREP_FCGEMM_DELEGATE_FCGEMM_DELEGATE_UTIL_H_
