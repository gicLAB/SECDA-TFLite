...
unsigned int dma_addrs[4] = {dma_addr0, dma_addr1, dma_addr2, dma_addr3}; // TODO: Do I need more here?
...
// //                              563840); // was 563840, made it stupid big /16192
// ACCNAME *acc;
...
public:
  ...
  TfLiteStatus Eval(TfLiteContext *context, TfLiteNode *node) override {
    ...
    // profile->saveCSVRecords(".data/vit_sim");
    //}
    return kTfLiteOk;
  };
...
void TfLiteVitDelegateDelete(TfLiteDelegate *delegate) {
  ...
  // SYSC_ON(profile.saveCSVRecords(".data/vit_sim_v2"));
#ifndef SYSC
  if (!dparams.unmap) {
