...
#pragma HLS UNROLL
            ...
            value1 =
              Quantised_Multiplier_FC(res[core][i][j + 0], fc_crf, fc_crx);
            value2 =
              Quantised_Multiplier_FC(res[core][i][j + 1], fc_crf, fc_crx);
            value3 =
              Quantised_Multiplier_FC(res[core][i][j + 2], fc_crf, fc_crx);
            value4 =
              Quantised_Multiplier_FC(res[core][i][j + 3], fc_crf, fc_crx);
            // wait();
          }
          // wait();
