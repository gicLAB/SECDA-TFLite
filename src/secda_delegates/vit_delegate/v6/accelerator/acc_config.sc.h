...
#define pe_tile 32 // Changing this to 128 breaks it - too many resources 

#define pn_tile 128
#define pm_tile 128
#define pk_tile 768 // we want to go up to 768?
// #define pk_tile 896 // we want to go up to 768?
