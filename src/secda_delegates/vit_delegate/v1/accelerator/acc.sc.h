...
SC_MODULE(ACCNAME) {
  ...
  sc_signal<int, SC_MANY_WRITERS> readTimeParamsS;
  sc_signal<int, SC_MANY_WRITERS> readTimeRowsS;
  sc_signal<int, SC_MANY_WRITERS> readTimeColsS;
  ...
  sc_signal<int, SC_MANY_WRITERS> rowReadReadyS;
  
  sc_signal<int, SC_MANY_WRITERS> colReadReadyS;

  sc_signal<int, SC_MANY_WRITERS> biasReadReadyS;

  sc_signal<int, SC_MANY_WRITERS> peReadReadyS;

  sc_signal<int, SC_MANY_WRITERS> pePostReadyS;
  ...
  sc_signal<int> readTimeParamsS;
  sc_signal<int> readTimeRowsS;
  sc_signal<int> readTimeColsS;
  ...
  // Implementation signals
  sc_signal<int> rowReadReadyS;

  sc_signal<int> colReadReadyS;

  sc_signal<int> biasReadReadyS;

  sc_signal<int> peReadReadyS;

  sc_signal<int> pePostReadyS;
#endif
  ...
  ClockCycles *readTimeRows = new ClockCycles("readTimeRows", true);
  ClockCycles *readTimeCols = new ClockCycles("readTimeCols", true);
  ...
  std::vector<Metric *> profiling_vars = {readTimeTotal, readTimeParam,
                                          readTimeRows, readTimeCols,
                                          readTimeBias, peTotal, peMultiply,
                                          peAccumulate, pePostTotal,
                                          pePostProcess, pePostWrite};
  ...
  void PE_Post(); // Defined in "pe_post.sc.h"
