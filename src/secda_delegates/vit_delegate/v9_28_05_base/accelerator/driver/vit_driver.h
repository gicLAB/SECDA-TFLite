...
void block_add(acc_container &drv) {
  ...
  // hwc
  drv.hwc->set_target_state(0, 0); // ReadInp
  drv.hwc->set_target_state(1, 0); // ReadWgt
  drv.hwc->set_target_state(2, 0); // ReadBias
  drv.hwc->set_target_state(3, 0); // ReadBias
  drv.hwc->set_target_state(4, 0); // ReadBias
  drv.hwc->set_target_state(5, 0); // ReadBias
  ...
  if (mode == 0) { 
    ...
    drv.hwc->print_hwc_map(true); // hwc
}
