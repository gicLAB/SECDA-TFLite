...
def main(raw_args=None):
    ...
    mypath = "/home/jude/Workspace/SECDA-TFLite_v2/src/benchmark_suite/files/"
    ...
    # signal.signal(signal.SIGINT, signal_handler)
    try:
        with open("/home/jude/Workspace/SECDA-TFLite_v2/src/benchmark_suite/files/coords.txt", "r") as f:
