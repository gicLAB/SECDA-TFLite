...
#include "tensorflow/lite/delegates/utils/secda_tflite/toy_accelerator/fpga_delegate/toy_delegate.h"
#include "tensorflow/lite/delegates/utils/secda_tflite/toy_accelerator/fpga_delegate/util.h"
#include "tensorflow/lite/delegates/utils/simple_delegate.h"

#include "accelerator/driver/add_driver.h"
#include "tensorflow/lite/delegates/utils/secda_tflite/hostside_optimize/acc_helpers.h"
...
struct acc_delegate_params* del;
...
class ToyDelegateKernel : public SimpleDelegateKernelInterface {
 public:
  ...
  TfLiteStatus Init(TfLiteContext* context,
    ...
    // Init
    if (!del->init) {
      del->acc = getAccBaseAddress<int>(0x43C00000, PAGE_SIZE);
      static struct stream_dma _sdma(0x40400000, 0x16000000, 4194304,
                                     0x16800000, 4194304);
      sdma = &_sdma;
      del->init = true;
      std::cout << "===========================" << std::endl;
  ...
  TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) override {
    ...
    for (int i = 0; i < node_count; i++) {
      cout << "===========================" << endl;
      cout << "ADD Layer: " << del->layer << "      Node: " << associated_nodes[i]
           << endl;
      cout << "===========================" << endl;
